...
const KitCTA = () => {
  return <section className="py-8 lg:py-20 bg-kit-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-6 lg:mb-12 animate-slide-up">
            <Badge variant="secondary" className="mb-4 lg:mb-6 text-white text-xs lg:text-sm px-4 py-2 bg-orange-600">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-4 lg:mb-8 max-w-3xl mx-auto font-semibold">Garante já o seu e ganhe tempo e aumente seus ganhos hoje mesmo!</p>
          </div>
                ...
                <div className="text-center space-y-4 lg:space-y-6">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-center gap-2 flex-wrap">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm flex items-center">
                          <svg width="40" height="24" viewBox="0 0 32 20" className="fill-current text-red-600">
                            ...
                            <text x="16" y="13" textAnchor="middle" className="text-[8px] font-bold fill-white">HIPER</text>
                          </svg>
                        </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg px-4 py-3 shadow-sm flex items-center">
                          <svg width="40" height="24" viewBox="0 0 32 20">
                            ...
                            <text x="16" y="13" textAnchor="middle" className="text-[8px] font-bold fill-white italic">VISA</text>
                          </svg>
                        </div>
                    ...
                    <div className="text-sm text-gray-600 font-medium">
                      🔒 Compra 100% segura • SSL • Dados protegidos
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          {/* Urgency */}
          <div className="text-center text-white animate-slide-up mb-6 lg:mb-8">
            
          </div>

          {/* Additional CTAs */}
          <div className="flex flex-col sm:flex-row gap-2 lg:gap-4 justify-center animate-slide-up mb-6 lg:mb-12">
            <Button variant="outline" className="border-2 border-white text-white bg-black/20 backdrop-blur-sm px-4 lg:px-8 py-3 lg:py-4 rounded-xl font-bold text-xs lg:text-lg hover:bg-white hover:text-black transition-all duration-300">
              Comprar agora
            </Button>
            <Button className="bg-gradient-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 border-2 border-green-400 hover:border-green-300 px-4 lg:px-8 py-3 lg:py-4 rounded-xl font-bold text-xs lg:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg group relative overflow-hidden">
              ...
              <div className="relative flex items-center justify-center gap-2">
                ...
                <div className="ml-1 text-xs bg-green-300 text-green-800 px-2 py-1 rounded-full font-extrabold animate-pulse">ONLINE</div>
              </div>
            </Button>
          </div>
